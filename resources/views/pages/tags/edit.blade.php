...
<div class="container">
   ...
   <div class="hk-pg-header">
      <h4 class="hk-pg-title offset-md-2"><span class="pg-title-icon"><span class="feather-icon"><i data-feather=""></i></span></span>Edit Offer</h4>
   </div>
   <!-- /Title -->
</div>
   ...
   <div class="row ">
      ...
      <div class="form-group">
            <div class="input-group">
               ...
               <input type="text" id="tag_name" name="tag_name" value="" placeholder="Enter offer name..." class="form-control" required aria-label="no default" aria-describedby="inputGroup-sizing-default">
            </div>
         </div>
