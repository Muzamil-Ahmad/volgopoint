...
@section('content')
   <div class="hk-settings-panel">
            <div class="nicescroll-bar position-relative">
                <div class="settings-panel-wrap">
                    <div class="settings-panel-head">
                        <img class="brand-img d-inline-block align-top" src="{{asset('admin_assets/dist/img/logo-light.png')}}" alt="brand" />
            ...
            <img class="d-none" src="{{asset('admin_assets/dist/img/logo-light.png')}}" alt="brand" />
            <img class="d-none" src="{{asset('admin_assets/dist/img/logo-light.png')}}" alt="brand" />
        </div>
        <!-- /Setting Panel -->
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						...
						<p>Welcome to the Dashboard of BrotherCart</p>
					</div>
								...
								<div class="card-group hk-dash-type-2">
									<div class="card card-sm">
										<div class="card-body">
											...
											<div>
												<span id="target_users" class="d-block display-4 text-dark mb-5">15</span>
